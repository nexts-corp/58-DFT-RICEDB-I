...
while($data = $res->fetch(PDO::FETCH_ASSOC)){
    ...
    //update field
    $sqlUp = "UPDATE dft_Rice_Info SET Warehouse_Code='".$conv."' WHERE Silo='".$data["Silo"]."' AND LK_Associate_Id='".$data["LK_Associate_Id"]."' AND LK_Province_Id='".$data["LK_Province_Id"]."'";

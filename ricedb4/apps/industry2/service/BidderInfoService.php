...
use apps\industry2\interfaces\IBidderInfoService;
...
class BidderInfoService extends CServiceBase implements IBidderInfoService {
    ...
    public function listsRegister() {
        ...
        $sql = "SELECT"
                ...
                . " bh.property3, bh.remark3, bh.property4, bh.remark4, bh.property5, bh.remark5, bh.property6, bh.remark6,bh.remark61,bh.remark62,bh.remark63, bh.checkIn,"
    ...
    public function listsPass() {
        ...
        $sql = "SELECT"
                ...
                . " bh.id as bidderHistoryId, bh.statusKeyword, bh.queue, bh.dateRegister,"
                . " bh.agentName, bh.agentName2,bh.agentName3, bh.mobile, bh.property1, bh.remark1, bh.property2, bh.remark2,"
                . " bh.property3, bh.remark3, bh.property4, bh.remark4, bh.property5, bh.remark5, bh.property6, bh.remark6, bh.remark61, bh.remark62, bh.remark63"
                . " FROM " . $this->ent . "\\BidderHistory bh"
                . " JOIN " . $this->ent . "\\BidderInfo bi WITH bh.bidderId = bi.id"
                . " WHERE bh.statusKeyword = :statusKeyword"
                . " AND bh.property1 = :p1"
...
//            $dataInfo[0]->typeOptional = $bidderInfo->typeOptional;
        ...
        if ($file != '') {
            $time = date("YmdHis");
            $target_dir = "apps\\industry2\\views\\attachment\\";
...
//        $dataInfo[0]->typeOptional = $bidderInfo->typeOptional;
        ...
        $dataHistory[0]->remark61 = $bidderHistory->remark61;
        $dataHistory[0]->remark62 = $bidderHistory->remark62;
        $dataHistory[0]->remark63 = $bidderHistory->remark63;
